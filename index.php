...
<body class="hold-transition login-page" style="background-image: url('assets/dist/img/1.jpg'); background-size: cover; background-repeat: no-repeat;">
    <div class="container-fluid flex bg-sky-600 flex-col justify-center items-center text-white p-5"
        style="height: 300px; opacity:70%;">
        <h1 class="font-weight-bold mb-3">Poliklinik UDINUS</h1>
        <h6>Bimbingan Karir 2023 Bidang Web</h6>
    </div>
